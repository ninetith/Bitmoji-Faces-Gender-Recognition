...
import pandas as pd
testimg_path='../深度学习/BitmojiDataset_Sample/testimages/'
submission_path='../深度学习/BitmojiDataset_Sample/sample_submission.csv'
...
model.load_state_dict(torch.load('./log.pth'))
model.eval()
with torch.no_grad():
    ...
    for img_name in parent_list:
        ...
        cnt+=1
test_df.to_csv('./resule.csv',index=0)
